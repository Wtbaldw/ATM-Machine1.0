...
public class userHomepage {
	...
	public static void openHomepage(String userCardNumber, char[] userPinNumber,String feedback) {
		...
		deposit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				frame.dispose();
				Deposit.openDeposit(userCardNumber, userPinNumber);
		...
		withdrawal.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				frame.dispose();
				Withdrawal.openWithdrawal(userCardNumber, userPinNumber);
			}
		...
		JLabel command2 = new JLabel("Feedback: No Recent Action ; Current Balance: $" + usersInfo[3]);
		if (feedback != null) {
			command2.setText(feedback);
		}
...
//		openHomepage("1234567812345678",new char[] {'1','2','3','4'});
//	}
}
