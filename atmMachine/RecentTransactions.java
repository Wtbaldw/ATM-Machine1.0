...
public class RecentTransactions {
	...
	public static JFrame frame = new JFrame("Recent Transactions");
	
	public static void openRecentTransactions(String userCardNumber, char[] userPinNumber) {
...
//--------------------
	...
	public static void main (String[] args) {
		openRecentTransactions("1234567812345678",new char[] {'1','2','3','4'});
	}
}
