...
public class PinChange {
	...
	public static JFrame frame = new JFrame("Pin Change");
	
	public static void openPinChange(String userCardNumber, char[] userPinNumber) {
...
//--------------------
	...
	public static void main (String[] args) {
		openPinChange("1234567812345678",new char[] {'1','2','3','4'});
	}
}
