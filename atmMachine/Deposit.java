...
public class Deposit {
	...
	public static void openDeposit(String userCardNumber, char[] userPinNumber) {
		...
		JLabel command1 = new JLabel("Please use slider or type amount for deposit:");
		...
		depositSlider.addChangeListener(e -> {
			...
			sliderValueLabel.setText("Deposit Amount: $" + value);
		});
		...
		JButton depositSliderAmount = new JButton("Click to Deposit Slider");
		...
		depositSliderAmount.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
					...
					String userFeedback = "Recent: Balance Added $" + addBalance + "; Current Balance: $" + newBalance;
					frame.dispose();
		...
		JLabel balance = new JLabel("Text Deposit, Enter Dollar amount with decimal (ex 14.24, or 10.00)",SwingConstants.CENTER);
		...
		JLabel command2 = new JLabel("Deposit");
...
//		openDeposit("1234567812345678",new char[] {'1','2','3','4'});
//	}
}
