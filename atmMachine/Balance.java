...
public class Balance {
	...
	public static JFrame frame = new JFrame("Balance");
	
	public static void openBalance(String userCardNumber, char[] userPinNumber) {
...
//--------------------
	...
	public static void main (String[] args) {
		openBalance("1234567812345678",new char[] {'1','2','3','4'});
	}
}
